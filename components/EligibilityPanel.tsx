      ...
      {!s.started ? (
        ...
        <>
          ...
          <Link href="/funding-eligibility" className="elig-gaps">
            {s.critical > 0 && <span className="eg red">🔴 {s.critical}</span>}
            {s.essential > 0 && <span className="eg ess">🟠 {s.essential}</span>}
            <span className="eg-label">readiness {s.readiness}%</span>
          </Link>
