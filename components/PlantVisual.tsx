...
// Each stem is ONE smooth curve from the plant base to its leaf's top notch
// (the sinus where the two upper lobes convene) — no kinks.
const MON_STEMS: [string, number, number, number, number, keyof Palette, boolean][] = [
  ["M-4,0 C -6,-38 -30,-74 -49.2,-109.8", -55, -92, 18, 1.45, "mid", false],
  ["M0,0 C 3,-46 -9,-92 -12.1,-128.1", -11, -112, -4, 1.25, "dark", false],
  ["M4,0 C 16,-30 45,-58 52.7,-93.5", 59, -78, -22, 1.3, "light", false],
  ["M2,0 C 6,-24 10,-47 11.6,-69.1", 11, -60, 4, 0.9, "deep", true],
  ["M6,0 C 20,-10 38,-10 48.6,-1.2", 55, 10, -30, 1.0, "deep", false],
];
