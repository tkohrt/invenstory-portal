  ...
  return (
    <section className="acct-card readiness-card">
      <div className="rc-head">
        ...
        <div style={{ flex: 1 }} />
        <button className={`btn ${computedAt ? "ghost" : "rc-run-cta"}`} onClick={analyze} disabled={analyzing}>{analyzing ? "Running Readiness Check…" : computedAt ? "Re-Run Readiness Check" : "Run Readiness Check"}</button>
      </div>
